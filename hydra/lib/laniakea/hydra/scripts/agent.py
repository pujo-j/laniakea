...
class LnkAgent(Agent):
    ...
    def __init__(
        ...
        from laniakea.hydra.loader.dask_plugin import LoaderPlugin
        distributed.Client(address=os.getenv("PREFECT__ENGINE__EXECUTOR__DASK__ADDRESS")).register_worker_plugin(
            LoaderPlugin(), "hydra-loader")
